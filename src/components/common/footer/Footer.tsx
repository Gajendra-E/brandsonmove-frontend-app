            ...
            <div className="footer-navigation">
                ...
                <div className="footer-navigation-item">
                    <div className="footer-location-address">
                        ...
                        <div className="address-text">
                            <p>{contactInfo?.address || "Plot 124, Parsik Hill, Sector 26-27, CBD, Belapur, Navi Mumbai"}</p>
                        </div>
                    </div>
                </div>
                <div className="footer-navigation-item">
                ...
                <div className="footer-navigation-item">
                    <div className="footer-contact-mail">
                        ...
                        <Link className="footer-links" to="">{contactInfo?.email || "info@mysite.com"}</Link>
                    </div>
                </div>
                <div className="footer-navigation-item">
