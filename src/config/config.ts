...
export const APP_CONFIG = {
  NAME: "KR4ALL",
  HUSURA_ADMIN_SECRET:
    "jVSLGWmPT5QpFx9JLZTo62stKwCXX2m24fCEzkGdsm4SbGrLa3PBgyTSc7uF6oS9",
  ...
  SUREPASS_APIS_TOKEN:
    "eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..xq-191hmb69EjYkJ5r4c2yAJNf2lMqnA_3PhfnCrzNY",
  ...process.env,
};

export const QR_CODE_BASE_URL = "https://app.kr4all.com/pharmacy/details?id=";

export const CC_EMAILS = ["rayapu00@rediffmail.com", "rayikaur@rediffmail.com"];
